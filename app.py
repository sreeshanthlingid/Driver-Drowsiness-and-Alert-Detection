        ...
        if faces:
         ...
         for face in faces:
            ...
            if(time.time()-st_time>max_driving_time):
                Exceeded_time.play()
                webbrowser.open("https://www.google.com/maps/search/hotels+near+me/@17.3932124,78.4865491,15z"
                                "/data=!3m1!4b1!4m8!2m7!5m5!5m4!1s2023-10-02!2i2!4m1!1i2!6e3?authuser=0&entry=ttu")
